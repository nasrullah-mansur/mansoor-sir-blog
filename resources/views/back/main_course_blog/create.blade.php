...
<div class="col-12">
    <div class="card">
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <form class="form" action="{{ route('main.course.blog.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="button_text" class="form-control square {{ $errors->has('button_text') ? 'is-invalid' : ''}} " placeholder="Button Text" name="button_text">
