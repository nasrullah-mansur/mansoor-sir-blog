          ...
          <form class="form" action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="btn_text" class="form-control square {{ $errors->has('title') ? 'is-invalid' : ''}} " placeholder="Btn Text" name="btn_text">
              ...
              <div class="form-group">
                ...
                <input type="text" id="btn_link" class="form-control square {{ $errors->has('title') ? 'is-invalid' : ''}} " placeholder="Btn Link" name="btn_link">
