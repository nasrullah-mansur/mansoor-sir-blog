@extends('back.layout.layout', [$title = 'All blog categories', $add_btn = 'Add new category', $add_btn_link = route('up.blog.category.create')])
...
@push('db_js')
    ...
    <script>
         ...
         $('.dataTable').on('click', '.delete-data', function(e) {
             e.preventDefault();
             let deleteRoute = "{{ route('up.blog.category.delete') }}";
