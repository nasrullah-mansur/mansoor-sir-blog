...
class CustomPageDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('link', function ($data) {
                return route('front.custom.page', $data->slug);
            })
            ...
            ->editColumn('action', function ($data) {
                return
                    '<div class="d-flex action-btn">
                        <a class="btn btn-icon btn-success" style="margin-right: 5px;" href="' . route('custom.page.edit', $data->id) . '"><i class="ft-edit"></i></a>
     ...
     *
     * @param \App\Models\CustomPage $model
