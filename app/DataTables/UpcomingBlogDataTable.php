...
class UpcomingBlogDataTable extends DataTable
{
    /**
            ...
            ->editColumn('action', function ($data) {
                return
                    '<div class="d-flex action-btn">
                        <a class="btn btn-icon btn-success" style="margin-right: 5px;" href="' . route('up.blog.edit', $data->id) . '"><i class="ft-edit"></i></a>
     ...
     *
     * @param \App\Models\UpcomingBlog $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(UpcomingBlog $model): QueryBuilder
    {
    ...
    {
        return 'UpcomingBlog_' . date('YmdHis');
    }
}
