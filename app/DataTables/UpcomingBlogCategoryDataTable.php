...
class UpcomingBlogCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('slug', function ($data) {
                return '<a target="_blank" href="' . route('up.blog.by.category', $data->slug) . '"> ' . route('up.blog.by.category', $data->slug) . '</a>';
            })
            ...
            ->editColumn('action', function ($data) {
                return
                    '<div class="d-flex action-btn">
                        <a class="btn btn-icon btn-success" style="margin-right: 5px;" href="' . route('up.blog.category.edit', $data->id) . '"><i class="ft-edit"></i></a>
     ...
     *
     * @param \App\Models\UpcomingBlogCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(UpcomingBlogCategory $model): QueryBuilder
    {
    ...
    {
        return 'UpcomingBlogCategory_' . date('YmdHis');
    }
}
