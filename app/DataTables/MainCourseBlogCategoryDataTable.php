...
class MainCourseBlogCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'maincourseblogcategory.action')
            ->addIndexColumn()
            ...
            ->editColumn('action', function ($data) {
                return
                    '<div class="d-flex action-btn">
                        <a class="btn btn-icon btn-success" style="margin-right: 5px;" href="' . route('main.course.blog.category.edit', $data->id) . '"><i class="ft-edit"></i></a>
     ...
     *
     * @param \App\Models\MainCourseBlogCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(MainCourseBlogCategory $model): QueryBuilder
    {
    ...
    {
        return 'MainCourseBlogCategory_' . date('YmdHis');
    }
}
